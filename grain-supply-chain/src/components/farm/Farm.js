...
function Farm() {
    return (
        <Container fluid className="page-main-section">
            <Container>
                <h1 className="page-heading-text" style={{ marginTop: "70px" }}>Farm</h1>
                        ...
                        <Row style={{ justifyContent: "space-evenly" }}>
                            <Col md={4} className="farm-inner-col">
                                <FarmInnerCard
                                    ...
                                    text='<li>Direct Member Input
                                    <br /><li>Graingrower Member Engagement
                                    <br /><li>National Policay Group
                                    <br /><li><a href="https://www.graingrowers.com.au/policy">GrainGrowers: Policy & Industry Issues</a>'
                                />
                            </Col>
                            <Col md={4} className="farm-inner-col">
                                <FarmInnerCard
                                    header="Policy supporting documents"
                                    text='<li><a href="https://greens.org.au/vic/policies/agriculture-policy">Agriculture Policy</a>
                                    ...
                                    <br /><li><a href="https://www.pir.sa.gov.au/__data/assets/pdf_file/0018/314334/McColl_-_speech_Agricultural_Policy_in_Australia_Aug_85.pdf">Agricultural Policy in Australia</a>'
                                />
                            </Col>
                            <Col md={4} className="farm-inner-col">
                                <FarmInnerCard
                                    header="Relevant legal supporting documents"
                                    text='<li><a href="https://uk.practicallaw.thomsonreuters.com/1-608-5865?transitionType=Default&contextData=(sc.Default)&firstPage=true">Agricultural law in Australia</a></div>'
                                />
                            </Col>
                        </Row>
                    </Card.Body>
                        ...
                        <Row style={{ justifyContent: "space-evenly" }}>
                            <Col md={4} className="farm-inner-col">
                                <FarmInnerCard
                                    ...
                                    text='<li><a href="https://grains.graincorp.com.au/wp-content/uploads/2021/08/Barley-Standards-2021-2022.pdf">Barley Standards 2021-2022</a>
                                    ...
                                    <br /><li><a href="https://grains.graincorp.com.au/wp-content/uploads/2021/08/Feed-Maize-Standards-2021-2022.pdf">Feed Maize Standards 2021-2022</a>'
                                />
                            </Col>
                            <Col md={4} className="farm-inner-col">
                                <FarmInnerCard
                                    header="Grain Standards"
                                    text='<li><a href="https://www.giwa.org.au/industry-hub/grain-standards/">Grain Standards in Western Australia</a>
                                    <br /><li><a href="https://www.agracom.com.au/forms/grain-standards">Grain Standards</a>'
                                />
                            </Col>
                            <Col md={4} className="farm-inner-col">
                                <FarmInnerCard
                                    header="Relevant supporting and learning documents"
                                    text='<li><a href="https://www.farmbiosecurity.com.au/wp-content/uploads/2019/07/Biosecurity-Manual-for-Grain-Producers.pdf">Biosecurity Manual for Grain Producers</a></div>'
                                />
                            </Col>
                        </Row>
                    </Card.Body>
